...
feature_all = list(features_path_net) + list(feature_pretrain) + list(feature_ppi_pca)
...
for train_val_index, test_index in group_kfold.split(df, y_multilabel, groups):
    ...
    output_prefix = '/storage/yangjianLab/sunshufeng/gamma_v7/results_250723/genefeat_epoch3_64+32_neg1000000_nn_not_weighted'
    ...
    class MLP(torch.nn.Module):
        ...
        def __init__(self, in_features, num_classes, num_hidden_1=64, num_hidden_2=32, num_hidden_3=16):
            super().__init__()
