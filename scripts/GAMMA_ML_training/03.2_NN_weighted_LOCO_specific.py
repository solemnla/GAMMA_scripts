...
feature_all = feature_genetics + feature_specific + list(feature_omim_clinvar_mgi)
...
for train_val_index, test_index in group_kfold.split(df, y_multilabel, groups):
    ...
    output_prefix = '/storage/yangjianLab/sunshufeng/gamma_v7/results_250722/weighted_specific_epoch3_64+32_neg1000000_nn_4'
