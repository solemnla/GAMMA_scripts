...
print("||===================================================================================")
eSMR <- read_smr_data1(SMR_DIRT,result,trait_name,qtl_type="eQTL",HEIDI=TRUE)
sSMR <- read_smr_data1(SMR_DIRT,result,trait_name,qtl_type="sQTL",HEIDI=TRUE)
pSMR <- read_smr_data1(SMR_DIRT,result,trait_name,qtl_type="pQTL",HEIDI=TRUE)
edSMR <- read_smr_data1(SMR_DIRT,result,trait_name,qtl_type="edQTL",HEIDI=TRUE) 

mSMR <- read_smr_data2(SMR_DIRT,result,trait_name,qtl_type="mQTL",QTL_link=CpG_link,HEIDI=TRUE)
hSMR <- read_smr_data2(SMR_DIRT,result,trait_name,qtl_type="hQTL",QTL_link=hQTL_link,HEIDI=TRUE)
caSMR <- read_smr_data2(SMR_DIRT,result,trait_name,qtl_type="caQTL",QTL_link=caQTL_link,HEIDI=TRUE)
...
select_SMR_results_in_QTL_name_list <- function(xSMR, QTL_name_list) {
    ...
    SMR_p_ACAT_tmp=SMR_p_ACAT[,which(colnames(SMR_p_ACAT) %in% QTL_name_list$V1)]
    SMR_probeID_tmp=SMR_probeID[,which(colnames(SMR_probeID) %in% paste0("probeID_",QTL_name_list$V1))]
    SMR_results_tmp=SMR_results[which(SMR_results$QTL_name %in%QTL_name_list$V1),]
...
QTL_name_list=fread(QTL_name_list_file, head=F)
...
write.table(SMR_results_within_locus,paste0(OUTPUT,"/MAGIC/results/",trait_name,"_HEIDI_MAGIC_within_locus.txt"),row=F,col=T,quo=F,sep="\t")
...
# write.table(MAGIC_results,paste0(OUTPUT,"/MAGIC/summary/",trait_name,"_HEIDI_MAGIC.txt"),row=F,col=T,quo=F,sep="\t")
...
write.table(eSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_eSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(sSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_sSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(pSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_pSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(edSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_edSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(mSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_mSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(hSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_hSMR.summary"),row=F,col=T,quo=F,sep="\t")
write.table(caSMR_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_caSMR.summary"),row=F,col=T,quo=F,sep="\t")
...
write.table(MAGIC_plot,paste0(OUTPUT,"/MAGIC/plot/",trait_name,"_HEIDI_MAGIC_plot.summary"),row=F,col=T,quo=F,sep="\t")
