...
class TEST_POST_SMR_DEMO(TEST_POST_SMR):
    def __init__(self):
        super().__init__(
            ...
            max_workers=1,
            other_MR_result_dir_path='/storage/yangjianLab/guoyazhou/GAMMA_git_data/MR/summary'
...
class TEST_DEBUG_20240729(TEST_POST_SMR):
    def __init__(self):
        super().__init__(
            trait_name='trait',
            gencode_file="/storage/yangjianLab/qiting/data/annotation/gencode/gencode.v40.GRCh38.gene.annotation.bed",
            bim_file="/storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_hg38_chrALL.bim",
            qtl_categories=['eQTL'],
            save_dir='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1817398925624082433_save',
            running_data_dir='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1817398925624082433',
            gwas_file='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1817398925624082433/trait_gwas.txt',
            max_workers=30,
            convert_to_hg38=True
        )


class TEST_DEBUG_20240801(TEST_POST_SMR):
    def __init__(self):
        super().__init__(
            trait_name='trait',
            gencode_file="/storage/yangjianLab/qiting/data/annotation/gencode/gencode.v40.GRCh38.gene.annotation.bed",
            bim_file="/storage/yangjianLab/sharedata/LD_reference/UKB/genotype_10K/BED_ukbEUR_imp_v3_INFO0.8_maf0.01_mind0.05_geno0.05_hwe1e6_10K_hg38_chrALL.bim",
            qtl_categories=['eQTL'],
            save_dir='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1818817581646086145_save',
            running_data_dir='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1818817581646086145',
            gwas_file='/storage/yangjianLab/chenwenhao/tmp/GAMMA_DEBUG/1817398925624082433/trait_gwas.txt',
            max_workers=30,
            convert_to_hg38=True
        )
